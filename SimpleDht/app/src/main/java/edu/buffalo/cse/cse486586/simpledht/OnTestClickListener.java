...
//        cvtest.put(KEY_FIELD, "key" + Integer.toString("yoyo"));
            cvtest.put(KEY_FIELD, "yoyoy");
            cvtest.put(VALUE_FIELD, "val" + Integer.toString(5));

            mContentResolver.insert(mUri, cvtest);

            cvtest.put(KEY_FIELD, "yoyoa");
            cvtest.put(VALUE_FIELD, "val" + Integer.toString(5));

            mContentResolver.insert(mUri, cvtest);
            cvtest.put(KEY_FIELD, "yoyoi");
            cvtest.put(VALUE_FIELD, "val" + Integer.toString(5));

            mContentResolver.insert(mUri, cvtest);
            cvtest.put(KEY_FIELD, "yoyor");
            cvtest.put(VALUE_FIELD, "val" + Integer.toString(5));

            mContentResolver.insert(mUri, cvtest);
            cvtest.put(KEY_FIELD, "yoyoh");
            cvtest.put(VALUE_FIELD, "val" + Integer.toString(5));

            mContentResolver.insert(mUri, cvtest);
            cvtest.put(KEY_FIELD, "yoyom");
            cvtest.put(VALUE_FIELD, "val" + Integer.toString(5));
