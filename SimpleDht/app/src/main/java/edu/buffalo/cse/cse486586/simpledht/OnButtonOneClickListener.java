...
/**
 * Created by sahil on 3/22/16.
 */




public class OnButtonOneClickListener implements View.OnClickListener {
    ...
    public OnButtonOneClickListener(TextView _tv, ContentResolver _cr) {
        mTextView = _tv;
            ...
            if (resultCursor == null) {
                ...
                throw new Exception();
                        ...
                        while (resultCursor.moveToNext()) {
                            ...
                            publishProgress(listkeyy+" || "+listvaly);
                        }
                        publishProgress("");
